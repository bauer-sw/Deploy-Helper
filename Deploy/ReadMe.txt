========================================================================
    KONSOLENANWENDUNG: Depends-Projektübersicht
========================================================================

Diese Depends-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Depends-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Depends.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
